...
#define GPIOA_USART1_TX             2U
#define GPIOA_USART1_RX             3U
#define GPIOA_ALERT                  4U
#define GPIOA_LED1                  5U
#define GPIOA_LED2                  6U
#define GPIOA_LED3                  7U
#define GPIOA_PIN8                  8U
#define GPIOA_PIN9                  9U
#define GPIOA_I2C_SDA               10U
#define GPIOA_PIN11                 11U
#define GPIOA_I2C_Control                 12U
#define GPIOA_SWDIO                 13U
#define GPIOA_SWCLK                 14U
#define GPIOA_PIN15                 15U

#define GPIOB_LED4                  0U
#define GPIOB_LED5                  1U
 ...
 * GPIOA setup:
 *
 * PA0  - GPIOA_WKUP1               (input pullup).
 * PA1  - GPIOA_ADC1                (input analog).
 * PA2  - GPIOA_PIN2                (input pullup).
 * PA3  - GPIOA_PIN3                (input pullup).
 * PA4  - GPIOA_ALERT                (input pullup).
 * PA5  - GPIOA_LED1                (output pushpull high).
 * PA6  - GPIOA_LED2                (output pushpull high).
 * PA7  - GPIOA_LED3                (output pushpull high).
 * PA8  - GPIOA_PIN8                (input pullup).
 * PA9  - GPIOA_PIN9                (input pullup).
 * PA10 - GPIOA_I2C_SDA               (input pullup).
 * PA11 - GPIOA_PIN11               (input pullup).
 * PA12 - GPIOA_I2C_Control               (input pullup).
...
#define VAL_GPIOA_MODER             (PIN_MODE_INPUT(GPIOA_WKUP1) |         \
                                     ...
                                     PIN_MODE_INPUT(GPIOA_I2C_Control) |          \
...
#define VAL_GPIOA_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOA_WKUP1) |     \
                                     ...
                                     PIN_OTYPE_OPENDRAIN(GPIOA_I2C_SDA) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN11) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_I2C_Control) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWDIO) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_SWCLK) |      \
                                     PIN_OTYPE_PUSHPULL(GPIOA_PIN15))
#define VAL_GPIOA_OSPEEDR           (PIN_OSPEED_HIGH(GPIOA_WKUP1) |        \
                                     PIN_OSPEED_HIGH(GPIOA_ADC1) |        \
                                     ...
                                     PIN_OSPEED_HIGH(GPIOA_I2C_SDA) |        \
                                     PIN_OSPEED_HIGH(GPIOA_PIN11) |         \
                                     PIN_OSPEED_HIGH(GPIOA_I2C_Control) |         \
...
#define VAL_GPIOA_PUPDR             (PIN_PUPDR_PULLUP(GPIOA_WKUP1) |       \
                                     ...
                                     PIN_PUPDR_PULLUP(GPIOA_I2C_SDA) |       \
                                     PIN_PUPDR_PULLUP(GPIOA_PIN11) |        \
                                     PIN_PUPDR_PULLUP(GPIOA_I2C_Control) |        \
...
#define VAL_GPIOA_ODR               (PIN_ODR_HIGH(GPIOA_WKUP1) |           \
                                     ...
                                     PIN_ODR_HIGH(GPIOA_I2C_Control) |            \
...
#define VAL_GPIOA_AFRH              (PIN_AFIO_AF(GPIOA_PIN8, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOA_I2C_SDA, 0U) |        \
                                     PIN_AFIO_AF(GPIOA_PIN11, 0U) |         \
                                     PIN_AFIO_AF(GPIOA_I2C_Control, 0U) |         \
 ...
 * GPIOB setup:
 *
 * PB0  - GPIOB_LED4                (output pushpull high).
 * PB1  - GPIOB_LED5                (output pushpull high).
 * PB2  - GPIOB_PIN2                (input pullup).
 * PB3  - GPIOB_PIN3                (input pullup).
 * PB4  - GPIOB_PIN4                (input pullup).
 * PB5  - GPIOB_PIN5                (input pullup).
 * PB6  - GPIOB_I2C1_SCL            (ALTERNATE).
 * PB7  - GPIOB_I2C1_SDA            (ALTERNATE).
 ...
 */
#define VAL_GPIOB_MODER             (PIN_MODE_OUTPUT(GPIOB_LED4) |         \
                                     PIN_MODE_OUTPUT(GPIOB_LED5) |           \
...
#define VAL_GPIOB_OTYPER            (PIN_OTYPE_PUSHPULL(GPIOB_LED4) |     \
                                     PIN_OTYPE_PUSHPULL(GPIOB_LED5) |       \
...
#define VAL_GPIOB_OSPEEDR           (PIN_OSPEED_HIGH(GPIOB_LED4) |        \
                                     PIN_OSPEED_HIGH(GPIOB_LED5) |          \
...
#define VAL_GPIOB_PUPDR             (PIN_PUPDR_PULLUP(GPIOB_LED4) |       \
                                     PIN_PUPDR_PULLUP(GPIOB_LED5) |         \
...
#define VAL_GPIOB_ODR               (PIN_ODR_HIGH(GPIOB_LED4) |           \
                                     PIN_ODR_HIGH(GPIOB_LED5) |             \
...
#define VAL_GPIOB_AFRL              (PIN_AFIO_AF(GPIOB_LED4, 0U) |        \
                                     PIN_AFIO_AF(GPIOB_LED5, 0U) |          \
 ...
 * GPIOC setup:
 *
 * PC0  - GPIOC_PIN0                (input pullup).
 * PC1  - GPIOC_PIN1                (input pullup).
 * PC2  - GPIOC_PIN2                (input pullup).
 * PC3  - GPIOC_PIN3                (input pullup).
 * PC4  - GPIOC_PIN4                (input pullup).
 * PC5  - GPIOC_PIN5                (input pullup).
 * PC6  - GPIOC_PIN6                (input pullup).
 * PC7  - GPIOC_PIN7                (input pullup).
 * PC8  - GPIOC_PIN8                (input pullup).
 * PC9  - GPIOC_PIN9                (input pullup).
 * PC10 - GPIOC_PIN10               (input pullup).
 * PC11 - GPIOC_PIN11               (input pullup).
 * PC12 - GPIOC_PIN12               (input pullup).
 * PC13 - GPIOC_PIN13               (input pullup).
...
#define VAL_GPIOF_AFRL              (PIN_AFIO_AF(GPIOF_OSC_IN, 0U) |        \
                                     ...
                                     PIN_AFIO_AF(GPIOF_PIN6, 1U) |          \
                                     PIN_AFIO_AF(GPIOF_PIN7, 1U))
