...
#define STM32_USART1SW                      STM32_USART1SW_SYSCLK
...
#define STM32_I2C_I2C2_RX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 5)   //not using
#define STM32_I2C_I2C2_TX_DMA_STREAM        STM32_DMA_STREAM_ID(1, 4)   //not using
